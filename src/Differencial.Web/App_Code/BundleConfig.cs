...
namespace Differencial.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/app/solicitante").Include(
                      "~/Scripts/app/Solicitante/editar.js"

            bundles.Add(new ScriptBundle("~/app/filial").Include(
                      "~/Scripts/app/Filial/modalEditar.js"
            #endregion


            return;
            /*
            #region "Componentes não utilizados ainda no projeto"
            // Peity
