...
namespace Differencial.Service.Services
{
    public class OperadorService : Service, IOperadorService
    {
        ...
        public void Salvar(Operador entidade, IFormFile inputFoto)
        {
            TryCatch(async () =>
            {
                ...
                if (entidade.Id == 0)
                {
                    ...
                    entidade.UrlFoto = SalvarFoto(entidade.UrlFoto, inputFoto);
                ...
                else
                {
                    ...
                    oldEntidade.UrlFoto = SalvarFoto(oldEntidade.UrlFoto, inputFoto);
        ...
        private string SalvarFoto(string UrlFotoAtual, IFormFile inputFoto)
        {
            if (inputFoto != null && inputFoto.FileName != null)
            {
                ...
                inputFoto.Salvar(path, UrlFotoAtual);
