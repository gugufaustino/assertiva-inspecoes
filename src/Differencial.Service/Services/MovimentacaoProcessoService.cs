...
namespace Differencial.Service.Services
{
	public class MovimentacaoProcessoService : Service, IMovimentacaoProcessoService
	{
		...
		public void Excluir(ICollection<MovimentacaoProcesso> movimentacaoProcesso)
		{

			foreach (var item in movimentacaoProcesso)
			{

				_movimentacaoProcessoRepositorio.Delete(item);
			}
